import control_data_flow from '../../assets/BUtil_ControlDataFlow.png'
...
<figure class="doc-figure">
    <img src="${control_data_flow}" width="921" height="861" loading="lazy" decoding="async" alt="BUtil_ControlDataFlow"/>
